...
describe("checkForCourierPlay", () => {
  ...
  it("should return false if the most recent play was a Courier whose div element has equal left padding to the current div element", () => {
    //  Arrange
    deck.logArchive = [
      "pNick plays a Throne Room.",
      "pNick plays a Courier.",
  ...
  it("should return false when the most recent play in the logArchive is not a Courier", () => {
    // Arrange
    deck.logArchive = [
      "pNick plays a Throne Room.",
    ...
    deck.latestPlay = "Vassal"; // Not a Courier
